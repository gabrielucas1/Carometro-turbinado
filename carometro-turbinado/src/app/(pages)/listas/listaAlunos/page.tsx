...
export default function ListaAlunos() {
    ...
    useEffect(() => {
        alunoDAO.getByTurmaId(idTurma!).then((alunos) => {
    ...
    return (
        <>
            ...
            {idTurmaAddAluno != null &&
                <div className="flex flex-col py-6 gap-4">
                    {listaAlunos.map((aluno) => (
                        <button onClick={() => adicionarAlunoTurma(aluno)} key={aluno.id} className="shadow-sm border-gray-900 border-1 bg-gray-50 rounded-lg w-96 h-32 p-3 flex hover:w-[25rem] transition-all cursor-pointer">
