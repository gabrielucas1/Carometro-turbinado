    ...
    return (
        <div className="w-full flex items-center flex-col px-96 h-full">
            ...
            <form onSubmit={btSalvar} className="flex flex-col items-center h-full">
                ...
                <input onChange={getInput} id="nome" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.nome} />

                <div className="flex flex-row w-full gap-10">
                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">CEP</p>
                        <input onChange={getInput} id="cep" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.cep} />
                    </div>

                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">Rua</p>
                        <input onChange={getInput} id="rua" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.rua} />
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full gap-10">
                    <div className="flex flex-col flex-1">
                        ...
                        <input onChange={getInput} id="bairro" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.bairro} />
                    </div>

                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">Número da casa</p>
                        <input onChange={getInput} id="numeroCasa" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.numeroCasa} />
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full gap-10">
                    <div className="flex flex-col flex-1">
                        ...
                        <input onChange={getInput} id="complemento" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.complemento} />
                    </div>

                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">Telefone</p>
                        <input onChange={getInput} id="telefone" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.telefone} />
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full gap-10">
                    <div className="flex flex-col flex-1">
                        ...
                        <input onChange={getInput} id="estado" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.estado} />
                    </div>

                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">Cidade</p>
                        <input onChange={getInput} id="cidade" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.cidade} />
                    </div>
                </div>
                ...
                <div className="flex flex-row w-full gap-10">
                    <div className="flex flex-col flex-1">
                        ...
                        <input onChange={getInput} id="rede" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.rede} />
                    </div>

                    <div className="flex flex-col flex-1">
                        <p className="mt-6 mb-1 self-start">Tipo de Ensino</p>
                        <input onChange={getInput} id="tipoEnsino" className="border-gray-400 p-1 border-2 rounded w-full h-9" value={escola.tipoEnsino} />
                    </div>
                </div>
