    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            {listUsuarios.map((usuario, index) => {
                ...
                return (
                    usuario.id != FBAutentication.usuarioLogado.id && usuario.tipoUsuario == TipoUsuario.ADMESCOLA ? (
                        <div key={index}>
            ...
            <button onClick={() => router.push("./addADMEscola")} className="absolute bottom-4 right-4 p-4 bg-blue-400">Adicionar</button>
        </div>
    )
}