    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            {listUsuarios.map((usuario, index) => {
                ...
                return (
                    usuario.id != usuarioLogado.id && usuario.tipoUsuario != TipoUsuario.ADMGERAL ? (
                        <div key={index}>
                            <button onClick={() => { router.push(`/outrasPaginas/perfil/perfilFuncionario?id=${usuario.id}`) }} className="bg-blue-400 w-96 h-20 mt-8 p-4 flex flex-col">
