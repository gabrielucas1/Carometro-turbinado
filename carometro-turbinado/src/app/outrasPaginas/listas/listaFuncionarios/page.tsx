    ...
    return (
        <div className="flex flex-col items-center w-full">
            ...
            {listUsuarios.map((usuario, index) => {
                ...
                console.log(`EscolaLogado: ${usuarioLogado.escola.id}`)
            ...
            <button onClick={() => router.push("/outrasPaginas/adicionar/addFuncionario")} className="absolute bottom-4 right-4 p-4 bg-blue-400">Adicionar</button>
        </div>
    )
}