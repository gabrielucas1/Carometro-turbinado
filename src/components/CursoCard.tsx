...
export default function CursoCard({ curso, escola, onDelete }: { curso: Curso; escola: string; onDelete?: () => void }) {
    ...
    function editarCurso(e: React.MouseEvent) {
        e.stopPropagation(); // Evita que o click do botão pai seja acionado
        router.push(`/editar/editCurso?id=${curso.id}`)
    }
